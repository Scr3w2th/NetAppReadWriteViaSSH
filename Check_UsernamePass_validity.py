...
def ssh_connection(ip):
    ...
    try:
        ...
        # For testing purposes this allows auto-accepting unknown host keys, DO NOT USE IN PROD!!! Default is 'RejectPolicy'
        ...
        # Writting each line in the file to the device
